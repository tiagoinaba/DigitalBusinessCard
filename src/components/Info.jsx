...
export default function Info() {
    return (
        ...
        <div className="card__info">
            ...
            <h1 className='card__info--name'>Tiago Inaba</h1>
            <h3 className="card__info--role">Frontend Developer</h3>
            <p className="card__info--website">tiagoinaba.website</p>

            <div className="card__info--contacts-div">
                ...
                <a href="https://www.linkedin.com/in/tiago-inaba-654774123/" target="_blank" className="linkedin">
